...
print("Iniciado Experimento Online...")
...
def online_experiment(amp, cfy):
    ...
    while True:
        ...
        print("Letra provavel--: %s" % "".join([i[0] for i in sorted(letter_prob.items(), key=lambda x: x[1], reverse=True)]).replace(current_letter, " '%s' " % current_letter))
...
if __name__ == '__main__':
    ...
    print('Configurando simulacao online...')
